...
urlpatterns = [
    ...
    path('design/<int:design_id>/test-suite/download/', views.test_suite_download, name='test_suite_download'),
    ...
    path('test-suites/steps/<int:step_id>/diagnostic-images/add/', views.test_step_diagnostic_image_add, name='test_step_diagnostic_image_add'),
    path('test-suites/diagnostic-images/<int:image_id>/delete/', views.test_step_diagnostic_image_delete, name='test_step_diagnostic_image_delete'),
    ...
    path('test-suites/manual-checks/<int:check_id>/', views.manual_check_edit, name='manual_check_edit'),
    path('test-suites/manual-checks/<int:check_id>/delete/', views.manual_check_delete, name='manual_check_delete'),
]
