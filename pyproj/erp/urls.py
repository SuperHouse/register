...
urlpatterns = [
    ...
    path('parts/source/<int:source_id>/delete/', views.part_source_delete, name='part_source_delete'),
    path('parts/source/<int:source_id>/refresh/', views.part_source_refresh, name='part_source_refresh'),
