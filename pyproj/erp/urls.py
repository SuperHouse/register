...
urlpatterns = [
    ...
    path('settings/production-stages/<int:production_stage_id>/move-<str:direction>/', views.production_stage_move, name='production_stage_move'),
    ...
    path('settings/production-stage-templates/step/<int:step_id>/move-<str:direction>/', views.production_stage_template_step_move, name='production_stage_template_step_move'),
