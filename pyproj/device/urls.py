...
urlpatterns = [
    ...
    path('<int:device_number>/add-asset/', views.device_asset_add, name='device_asset_add'),
    path('da/<int:asset_id>/', views.device_asset_edit, name='device_asset_edit'),
    path('da/<int:asset_id>/delete/', views.device_asset_delete, name='device_asset_delete'),
