...
def _flush_app_data():
    ...
    from erp.models import BatchProductionStage, Batch, Location, Part, PartAsset, PartCategory, PartSource, ProductionStageTemplateStep, ProductionStageTemplate, ProductionStage
